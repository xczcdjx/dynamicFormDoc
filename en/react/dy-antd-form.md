...
1. Please make sure Ant Design is installed. All the forms below are simplified wrappers built on top of the original components.
2. The Ant Design version must be 5 or later.

## 1.Simple usage

<BlockOther pathUrl="/testPackage-react/#/form" isOpen>
<template #default="{dl}">
...
> (All render2 functions are custom)

<BlockOther pathUrl="/testPackage-react/#/form/customForm" isOpen>
<template #default="{dl}">
<PreviewBlock v-bind="dl"/>
</template>
<template #code>
...
> (You can omit render2)

<BlockOther pathUrl="/testPackage-react/#/form/decorateForm" isOpen>
<template #default="{dl}">
...
> All render2 functions are imported from "dynamicformdjx/antd"

<BlockOther pathUrl="/testPackage-react/#/form/allForm" isOpen>
<template #default="{dl}">
